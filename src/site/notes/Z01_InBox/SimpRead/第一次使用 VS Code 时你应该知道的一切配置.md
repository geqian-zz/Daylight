---
{"dg-publish":true,"aliases":[null],"tags":["4_Information"],"number headings":"auto, first-level 1, max 6, A.1.","url":"https://zhuanlan.zhihu.com/p/62913725","title":"第一次使用 VS Code 时你应该知道的一切配置","summary":null,"Created-Date":"2023-09-10 10:06:05","Modified-Date":"2024-04-18 11:52:10","permalink":"/Z01_InBox/SimpRead/第一次使用 VS Code 时你应该知道的一切配置/","dgPassFrontmatter":true}
---
...
![](https://pic3.zhimg.com/v2-e3c0928b36fb9f7e4f453744774d37ea_r.jpg)
...
### Z.2.3. 前端利器之争： VS Code 与 WebStorm
...
![](https://pic1.zhimg.com/v2-5772750d88513bc6674e3daf85349728_r.jpg)

上图中，直接点击 download，一键下载安装即可。

## Z.3. 二、崭露锋芒：VS Code 快捷键
...
![](https://pic1.zhimg.com/v2-232cc9c5e71c3e4a2d5f17017f5de6a0_r.jpg)

### Z.3.2. 2、跳转操作

![](https://pic4.zhimg.com/v2-1f02da39039833ba509ecc0670e13d73_r.jpg)

### Z.3.3. 3、移动光标

![](https://pic3.zhimg.com/v2-0c9c747d7884a0a294cf5bc8618dea3a_r.jpg)

### Z.3.4. 4、编辑操作

![](https://pic4.zhimg.com/v2-52c6bb5c1336d71114bbc50a8800952b_r.jpg)

### Z.3.5. 5、多光标编辑

![](https://pic3.zhimg.com/v2-42bc09affc0886afc8d5db7cf2734146_r.jpg)
...
![](https://pic2.zhimg.com/v2-0f5df2f03ef39a66e4c3f28a52541189_r.jpg)

备注：上面所讲到的移动光标、编辑操作、删除操作的快捷键，在其他编辑器里，大部分都适用。

### Z.3.7. 7、编程语言相关

![](https://pic1.zhimg.com/v2-600a3840a9f8998dffa7a843279838b4_r.jpg)

### Z.3.8. 8、搜索相关

![](https://pic4.zhimg.com/v2-c5f12eb734bcf7d6a42fe25a9fe9ad1b_r.jpg)
...
![](https://pic3.zhimg.com/v2-a36f8aaf34bd8bf72bb234ba224d739e_r.jpg)

### Z.3.10. 10、快捷键列表

你可以点击 VS Code 左下角的齿轮按钮，效果如下：

![](https://pic1.zhimg.com/v2-e41a7ae9abb21a4cbd67d346ee5518b0_r.jpg)

上图中，在展开的菜单中选择「键盘快捷方式」，就可以查看和修改所有的快捷键列表了：

![](https://pic4.zhimg.com/v2-7564aad8e26289c44fbc3ebf2aea0027_r.jpg)
...
![](https://pic1.zhimg.com/v2-47c6208607b65d940a291870b6c8f7f8_r.jpg)
...
![](https://pic4.zhimg.com/v2-f093337635a30d002de43124e09fa733_r.jpg)
...
![](https://pic2.zhimg.com/v2-397b0b0ae551cf1f15257acb2d5acc19_r.jpg)

### Z.4.4. 4、使用命令行启动 VS Code

（1）输入快捷键「Cmd + Shift + P 」，选择 `install code command`：

![](https://pic2.zhimg.com/v2-3bf7696c7a70e555e94d881aa7d052f9_r.jpg)
...
## Z.5. 四、私人订制：VS Code 的常见配置

### Z.5.1. 1、VS Code 设置为中文语言
...
### Z.5.2. 2、面包屑（Breadcrumb）

打开 VS Code 的设置项，选择「用户设置 -> 工作台 -> 导航路径」，如下图所示：

![](https://pic1.zhimg.com/v2-01d1c9e89d7d8e2e6d35d2e85c96ff94_r.jpg)

上图中，将红框部分打钩即可。

设置成功后，我们就可以查看到当前文件的「层级结构」，非常方便。如下图所示：

![](https://pic1.zhimg.com/v2-1178f7cced266e18d114179ca6249eb0_r.jpg)

有了这个面包屑导航，我们可以在任意目录、任意文件之间随意跳转。

### Z.5.3. 3、左右显示多个编辑器窗口（抄代码利器）
...
![](https://pic3.zhimg.com/v2-7f63c1655e053e6786cc64a46d0c0fe6_r.jpg)

我建议保留这个设置项，无需修改。

### Z.5.5. 5、右侧是否显示代码的缩略图

VS Code 会在代码的右侧，默认显示缩略图。你可以在设置项里搜索 `editor.minimap` 进行设置，配置项如下：

![](https://pic3.zhimg.com/v2-26b12090201ff02d63254c9917accdde_r.jpg)

### Z.5.6. 6、将当前行代码高亮显示（更改光标所在行的背景色）
...
![](https://pic2.zhimg.com/v2-9bb2fdc43aaf6cb6a0f529c885504b89_r.jpg)
...
### Z.5.8. 8、保存代码后，是否立即格式化

保存代码后，默认 **不会立即** 进行代码的格式化。你可以在设置项里搜索 `editor.formatOnSave` 查看该配置项：

![](https://pic4.zhimg.com/v2-24e21a58a5c049fe899d9900d2de158b_r.jpg)
...
![](https://pic3.zhimg.com/v2-9bfd4143137ebd7e1326df8699450146_r.jpg)

*   **editor.insertSpaces**：按 Tab 键时插入空格（默认）。截图如下：

![](https://pic3.zhimg.com/v2-171efa7352c4dddaba4e967efc77ccda_r.jpg)

*   **editor.tabSize**：一个制表符默认等于四个空格。截图如下：

![](https://pic1.zhimg.com/v2-08dc47c8bf9029ba3f925f8a78afa054_r.jpg)

### Z.5.10. 10、新建文件后的默认文件类型

当我们按下快捷键「Cmd + N」新建文件时，VS Code 默认无法识别这个文件到底是什么类型的，因此也就无法识别相应的语法高亮。

如果你想修改默认的文件类型，可以在设置项里搜索 `files.defaultLanguage`，设置项如下：

![](https://pic2.zhimg.com/v2-fbc5e1ba86724d32a3d161dee4294299_r.jpg)

上图中的红框部分，填入你期望的默认文件类型。我填的是 `html` 类型，你也可以填写成 `javascript` 或者 `markdown`，或者其他的语言类型。

### Z.5.11. 11、删除文件时，是否弹出确认框

当我们在 VS Code 中删除文件时，默认会弹出确认框。如果你想修改设置，可以在设置项里搜索 `xplorer.confirmDelete`。截图如下：

![](https://pic4.zhimg.com/v2-d3ec15cef7c9aaf3578982ee87aa7f0b_r.jpg)
...
![](https://pic1.zhimg.com/v2-f358fe34aac13e50b59bfd9b01e0eb50_r.jpg)

VS Code 自带的对比功能并不够强大，我们可以安装插件 `compareit`，进行更丰富的对比。比如说，安装完插件 `compareit` 之后，我们可以将「当前文件」与「剪切板」里的内容进行对比：

![](https://pic3.zhimg.com/v2-4330f59f965f2c0790110b1a97b518da_r.jpg)

### Z.5.13. 13、查找某个函数在哪些地方被调用了
...
![](https://pic4.zhimg.com/v2-cbe55b8fb428d65c5c720f08cf25496b_r.jpg)
...
![](https://pic1.zhimg.com/v2-f35f1dc03dec35398feb8573bb618988_r.jpg)
...
![](https://pic3.zhimg.com/v2-c5656b9f0c4f02db4e6bac9af00f4dea_r.jpg)
...
![](https://pic1.zhimg.com/v2-7018de46a1aef7ec852dba5976a3b3a8_r.jpg)
...
![](https://pic2.zhimg.com/v2-64402409c5e10c023e1f4e13ce5d68b1_r.jpg)

那么，就可以创建多层子文件夹，效果如下：

![](https://pic3.zhimg.com/v2-711bc5945035986c094ee1684a14ae8e_r.jpg)

### Z.5.21. 21、`.vscode` 文件夹的作用
...
### Z.5.25. 25、修改字体，使用「Fira Code」字体

这款字体很漂亮，很适合用来写代码：

![](https://pic3.zhimg.com/v2-2b9de96e988304c6d6432084107d842a_r.jpg)
...
![](https://pic4.zhimg.com/v2-a1fb07127c1d90400d2bab237f632e8b_r.jpg)

上图中，我们点击最新的那条记录，就可将云端的最新配置同步到本地：

![](https://pic1.zhimg.com/v2-8ca809351b96e1a358b3126b35bb4bec_r.jpg)
...
### Z.7.3. 3、Live Server 【荐】

在本地启动一个服务器，代码写完后可以实现「热更新」，实时地在网页中看到运行效果。就不需要每次都得手动刷新页面了。

使用方式：安装插件后，开始写代码；代码写完后，右键选择「Open with Live Server」。

### Z.7.4. 4、Chinese (Simplified) Language Pack for Visual Studio Code

让软件显示为简体中文语言。

### Z.7.5. 5、Bracket Pair Colorizer 2：突出显示成对的括号【荐】
...
### Z.7.14. 14、Markdown Preview Github Styling 【荐】

以 GitHub 风格预览 Markdown 样式，十分简洁优雅。就像下面这样，左侧书写 Markdown 文本，右侧预览 Markdown 的渲染效果：

![](https://pic2.zhimg.com/v2-286d291a3f610fdfaa11d7305c7abb79_r.jpg)

### Z.7.15. 15、Markdown Preview Enhanced

预览 Markdown 样式。

### Z.7.16. Markdown All in One

这个插件将帮助你更高效地在 Markdown 中编写文档。

### Z.7.17. 16、Settings Sync【荐】
...
### Z.7.20. 19、ES7 React/Redux/GraphQL/React-Native snippets

React/Redux/react-router 的语法智能提示。

### Z.7.21. 20、minapp：小程序支持

小程序开发必备插件。

### Z.7.22. 21、Prettier：代码格式化

Prettier 是一个代码格式化工具，只关注格式化，但不具备校验功能。在一个多人协同开发的团队中，统一的代码编写规范非常重要。一套规范可以让我们编写的代码达到一致的风格，提高代码的可读性和统一性。自然维护性也会有所提高。

### Z.7.23. 22、ESLint：代码格式校验
...
### Z.7.25. 24、JavaScript(ES6) code snippets

ES6 语法智能提示，支持快速输入。

### Z.7.26. 25、Search node_modules 【荐】
...
![](https://pic4.zhimg.com/v2-661dde05148665f5e4773c2a9ce99dd3_r.jpg)

### Z.7.27. 26、indent-rainbow：突出显示代码缩进

`indent-rainbow` 插件：突出显示代码缩进。

安装完成后，效果如下图所示：

![](https://pic4.zhimg.com/v2-1cbc1b92f792548518ddc4b4c56f4a2f_r.jpg)

### Z.7.28. 27、javascript console utils：快速打印 log 日志【荐】
...
### Z.7.29. 28、Code Spell Checker：单词拼写错误检查

这个拼写检查程序的目标是帮助捕获常见的单词拼写错误，可以检测驼峰命名。从此告别 Chinglish.

### Z.7.30. 29、Local History 【荐】

维护文件的本地历史记录，强烈建议安装。代码意外丢失时，有时可以救命。

![](https://pic4.zhimg.com/v2-9397d87a27ed453a1302e72d419df1e7_r.jpg)

### Z.7.31. 30、Polacode-2020：生成代码截图 【荐】
...
![](https://pic1.zhimg.com/v2-1fac232cde6ecb7388ca2748d3b4b55c_r.jpg)
...
### Z.7.32. 31、Image Preview 【荐】

图片预览。鼠标移动到图片 url 上的时候，会自动显示图片的预览和图片尺寸。

### Z.7.33. 32、Auto Close Tag、Auto Rename Tag

自动闭合标签、自动对标签重命名。

### Z.7.34. 33、Better Comments
...
### Z.7.36. 35、Vue CSS Peek

CSS Peek 对 Vue 没有支持，该插件提供了对 Vue 文件的支持。

### Z.7.37. 36、Color Info
...
![](https://pic3.zhimg.com/v2-753648d9a2e4ba80006b02356c9928a2_r.jpg)

这个插件目前使用的人还不多，赶紧安装起来尝尝鲜吧。

### Z.7.39. 38、Live Share：实时编码分享
